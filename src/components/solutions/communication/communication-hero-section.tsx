...
export function CommunicationHeroSection() {
    ...
    useEffect(() => {
        const ctx = gsap.context(() => {
            ...
            tl.from(".com-hero-eyebrow", { y: 16, opacity: 0, duration: 0.55 })
                .from(
                    ".com-hero-line",
                    { y: 56, opacity: 0, stagger: 0.08, duration: 0.9 },
                    "-=0.25"
                )
                .from(".com-hero-copy", { y: 18, opacity: 0, duration: 0.6 }, "-=0.4")
                .from(".com-hero-action", { y: 14, opacity: 0, duration: 0.5 }, "-=0.3")
                .from(
                    ".com-hero-chip",
        ...
        >
            ...
            <div className="relative mx-auto max-w-[1500px] px-5 pb-16 pt-16 sm:px-8 lg:px-12 lg:pb-22 lg:pt-20 xl:px-16">
                <div className="max-w-[900px]">
                    <div className="com-hero-eyebrow flex items-center gap-3">
                    ...
                    <h1 className="mt-7">
                        <span className="com-hero-line block overflow-hidden">
                    ...
                    <p className="com-hero-copy mt-8 max-w-[540px] text-base leading-7 text-black/55 sm:text-lg sm:leading-8">
                        EPABX / IP PBX, intercom, public address, video conferencing and
                        distribution links — designed for clear operations, not isolated
                        handsets.
                    </p>

                    <div className="com-hero-action mt-9 flex flex-wrap items-center gap-4">
                        <Link
                            href="/contact"
                        ...
                        >
                            <span>Scope communication systems</span>
                            <ArrowUpRight
                                size={15}
                ...
                <div className="mt-12 flex flex-wrap gap-2.5">
                    {systems.map((item) => {
                        ...
                        return (
                            <div
                                key={item.label}
                                className="com-hero-chip inline-flex items-center gap-2.5 border border-black/[0.08] bg-white/85 px-4 py-2.5"
                            >
