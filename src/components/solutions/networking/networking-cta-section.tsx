...
import { ArrowUpRight, Cable, Mail, Phone } from "lucide-react";
...
export function NetworkingCtaSection() {
    ...
    return (
        ...
        >
            ...
            <div className="relative mx-auto max-w-[1500px] px-5 py-20 sm:px-8 lg:px-12 lg:py-28 xl:px-16">
                <div className="net-cta relative overflow-hidden border border-white/10 bg-[#f3f1ec] text-[#171717]">
                    <div
                        aria-hidden="true"
                        ...
                        <div>
                            ...
                            <h2 className="mt-6 max-w-[620px] text-[clamp(2rem,3.4vw,3.4rem)] font-medium leading-[1] tracking-[-0.05em]">
                                ...
                                <span className="block text-black/30">
                                    that can carry the stack?
                                </span>
                            </h2>

                            <p className="mt-6 max-w-[460px] text-[15px] leading-7 text-black/50">
                                Share floor count, device density and whether you need cabling,
                                Wi-Fi, fibre or a server room — we’ll outline a clean
                                infrastructure path.
                            </p>
