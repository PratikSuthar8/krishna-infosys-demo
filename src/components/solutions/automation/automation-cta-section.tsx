...
import { ArrowUpRight, Flame, Mail, Phone } from "lucide-react";
    ...
    return (
        ...
        >
            ...
            <div className="relative mx-auto max-w-[1500px] px-5 py-20 sm:px-8 lg:px-12 lg:py-28 xl:px-16">
                <div className="auto-cta relative overflow-hidden border border-white/10 bg-[#f3f1ec] text-[#171717]">
                    <div
                        aria-hidden="true"
                        ...
                        <div>
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-[10px] font-semibold uppercase tracking-[0.24em] text-[#f56616]">
                                    Automation & safety consultation
                                </span>
                            </div>

                            <h2 className="mt-6 max-w-[620px] text-[clamp(2rem,3.4vw,3.4rem)] font-medium leading-[1] tracking-[-0.05em]">
                                Need control, comfort
                                <span className="block text-black/30">
                                    and life-safety aligned?
                                </span>
                            </h2>

                            <p className="mt-6 max-w-[460px] text-[15px] leading-7 text-black/50">
                                Home automation, building control or fire alarm — share property
                                type, zone count and safety requirements. We’ll outline a clear
                                system path.
                            </p>
