...
export function SecurityHeroSection() {
    ...
    useEffect(() => {
        const ctx = gsap.context(() => {
            ...
            tl.from(".sec-hero-eyebrow", { y: 16, opacity: 0, duration: 0.55 })
                .from(
                    ".sec-hero-line",
                    { y: 56, opacity: 0, stagger: 0.08, duration: 0.9 },
                    "-=0.25"
                )
                .from(".sec-hero-copy", { y: 18, opacity: 0, duration: 0.6 }, "-=0.4")
                .from(".sec-hero-action", { y: 14, opacity: 0, duration: 0.5 }, "-=0.3")
                .from(
                    ".sec-hero-chip",
        ...
        >
            ...
            <div className="relative mx-auto max-w-[1500px] px-5 pb-16 pt-16 sm:px-8 lg:px-12 lg:pb-22 lg:pt-20 xl:px-16">
                <div className="max-w-[900px]">
                    <div className="sec-hero-eyebrow flex items-center gap-3">
                    ...
                    <h1 className="mt-7">
                        <span className="sec-hero-line block overflow-hidden">
                        ...
                        <span className="sec-hero-line block overflow-hidden">
                            <span className="block text-[clamp(2.5rem,5.4vw,5.4rem)] font-medium leading-[0.92] tracking-[-0.06em] text-black/30">
                                for people, premises and assets.
                            </span>
                        </span>
                    </h1>

                    <p className="sec-hero-copy mt-8 max-w-[540px] text-base leading-7 text-black/55 sm:text-lg sm:leading-8">
                        CCTV, access control, intrusion, barriers and video door phones
                        designed as one defensive layer — monitored, documented and
                        supportable after handover.
                    </p>

                    <div className="sec-hero-action mt-9 flex flex-wrap items-center gap-4">
                        <motion.div
                            whileHover={{ y: -2 }}
                            whileTap={{ scale: 0.98 }}
                        >
                            <Link
                                ...
                                <span>Scope a security system</span>
                ...
                <div className="mt-12 flex flex-wrap gap-2.5">
                    {systems.map((item) => {
                        ...
                        return (
                            <div
                                key={item.label}
                                className="sec-hero-chip inline-flex items-center gap-2.5 border border-black/[0.08] bg-white/85 px-4 py-2.5"
                            >
