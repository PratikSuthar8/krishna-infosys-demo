...
import { ArrowUpRight, Mail, MonitorPlay, Phone } from "lucide-react";
    ...
    return (
        ...
        >
            ...
            <div className="relative mx-auto max-w-[1500px] px-5 py-20 sm:px-8 lg:px-12 lg:py-28 xl:px-16">
                <div className="av-cta relative overflow-hidden border border-white/10 bg-[#f3f1ec] text-[#171717]">
                    <div
                        aria-hidden="true"
                    ...
                    <div className="relative grid gap-10 px-6 py-12 sm:px-10 lg:grid-cols-[1.25fr_0.75fr] lg:items-end lg:gap-16 lg:px-14 lg:py-16">
                        <div>
                            ...
                            <p className="mt-6 max-w-[460px] text-[15px] leading-7 text-black/50">
                                Boardroom, auditorium, lobby signage or home theatre — share
                                room type, capacity and use pattern. We’ll outline a practical
                                AV path.
                            </p>
